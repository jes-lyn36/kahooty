  ...
  return (
    <>
      <Card id="dashboard-game-card" style={{ width: '18rem' }}>
        <Card.Img style={{height:"286px", width:"290px", objectFit:"cover"}} variant="top" src={!game.thumbnail || game.thumbnail === "" ? './src/assets/no_image.png' : game.thumbnail} alt={game.thumbnail ? `${game.name} thumbnail` : 'No game image available'}/>
